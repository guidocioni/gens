...
def main():
    ...
    t_850 = (dset['t'] - 273.15)
    t_850_std = t_850.std(axis=0, skipna=True).compute()
    t_850_mean = t_850.mean(axis=0, skipna=True).compute()
...
def plot_files(dates, **args):
    ...
    for date in dates:
        ...
        an_var = annotation(
            args['ax'], '$T$ at 850 hPa (mean and std.)', loc='lower left', fontsize=7)
